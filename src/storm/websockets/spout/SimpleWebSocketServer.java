...
/**
 * Wrapper round the WebSocketServer class. Provides a simplified WebSocketServer which hides the details.
 * 
...
public class SimpleWebSocketServer {
  ...
  private WebSocketServer   ws = new WebSocketServer() {
                                  ...
                                  * @param message
                                  * 
                                  * @see com.netiq.websocket.WebSocketServer#onClientMessage(com.netiq.websocket.WebSocket,
                                  *      java.lang.String)
                                  */
                                 @Override
                                 public void onClientMessage(WebSocket conn, String message) {
                                   SimpleWebSocketServer.this.listener.onMessageReceived(message);
                                 }
